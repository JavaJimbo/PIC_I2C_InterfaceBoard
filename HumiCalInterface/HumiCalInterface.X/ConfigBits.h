 ...
 * Author: Jim
 *
 * Created on June 19, 2020, 5:09 PM
 */
...
#pragma config WDTPS = 4096     // Watchdog Timer Postscale Select bits (1:256)    Watchdog timeout = 4096 or four seconds approximately
